    ...
    def do_episode(self, task, i, train=True, global_step_limit = 1000000000000):
        ...
        while truncated == False and  terminated == False and incomplete == False: # while not done
            ...
            if train==True:
              ...
              if exp==True or self.config.store_all_transitions == "yes": self.learner.store_transition(observation_tm1,action_t,reward_t,observation_t,terminated or truncated) 
              self.learner.learn(task,step_counter)	
